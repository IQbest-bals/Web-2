...
{    public function showLoginForm()
    ...
    public function login(Request $request)
    {
        ...
        $credentials = $request->only('email', 'password');        if (Auth::attempt($credentials, $request->filled('remember'))) {
    ...
    public function logout(Request $request)
    {
        ...
        return redirect()->route('login-user')->with('success', 'Logout berhasil!');
    }
